...
Manual / eval checklist for engine **v4.0**. Replaying a flooded-casino-style path must show interlocking systems — not isolated prompt rules.
...
6. **Soft end** — Main climax (e.g. explosion) may emit `<SOFT_END>` / MAIN PLOT COMPLETED without locking input.
...
- [ ] Engine version banner shows v4.0
